...
def create_button(self, text, row, col, frame):
      button = tk.Button(frame, text=text, font=('arial', 18, 'bold'), textvariable = self.input_text, 
      fg='black', width=9, height=3, bd=0, bg='#fff', cursor= "hand2", command= lambda: self.on_button_click(text))
